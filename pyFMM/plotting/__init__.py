"""Plotting subpackage auto-importer.

Automatically imports all modules in `pyFMM.plotting` and re-exports
their public symbols so adding new plotting modules is automatic.
"""
import importlib
import pkgutil
import inspect
